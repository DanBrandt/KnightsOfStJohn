...
\latinenglish{
	...
	Dómine Iesu Christe, Rex glóriæ, líbera ánimas ómnium fidélium defunctórum de p\oe nis inférni et de profúnda lacu; {\color{red}*} líbera eas de ore leónis, ne absórbeat eas tártarus, ne cad\textbf{ant} \textit{in ob}\textbf{scú}rum; sed sígnifer sanctus Míchaël repræséntet eas in lucem sanctam, {\color{red}*} quam olim Abrahæ promisísti et sémini eius.
	...
	{\color{red}\Vbar.} Lord, have mercy. Pater noster. {\color{red}\textit{(secreto)}}
	...
	{\color{red}\Vbar.} Benedic\'{a}mus Domino.
	
	{\color{red}\Rbar.} Deo gr\'{a}tias.
}{
	...
	{\color{red}\Vbar.} At lead us not into temptation.
